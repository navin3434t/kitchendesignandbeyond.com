        ...
        <div class="zoo-theme-settings">
            <div class="nav-bar">
                ...
                <ul>
                    ...
                    <li><a class="nav-item" href="#advanced-settings"><?php esc_html_e('Advanced', 'fona') ?></a></li>
            ...
            <div class="content-tabs">
                <form class="form-table" action="options.php" method="post">
                    ...
                    <table id="global-settings" class="tab-table active-tab">
                        <caption><?php esc_html_e('General Options', 'fona') ?></caption>
                        <tr>
                            <?php $enable_mega_menu = intval($this->getValue('enable_builtin_mega_menu')) ?>
                            <th rowspan="scope"><?php esc_html_e('Enable Built-in Mega Menu Editor', 'fona') ?></th>
                            <td>
                                <label>
                                    ...
                                    <span class="description"><?php esc_html_e('Whether to enable built-in mega menu or not.', 'fona'); ?></span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e('Header scripts', 'fona') ?></th>
                            <td><p><textarea name="<?php echo esc_attr($this->getName('header_scripts')) ?>" rows="6" cols="80"><?php echo wp_unslash($this->getValue('header_scripts')) ?></textarea></p><p class="description"><?php esc_html_e('Here come custom scripts inserted inside HEAD tag.', 'fona') ?></p></td>
                        </tr>
                        <tr>
                            <th scope="row"><?php esc_html_e('Footer scripts', 'fona') ?></th>
                            <td><p><textarea name="<?php echo esc_attr($this->getName('footer_scripts')) ?>" rows="6" cols="80"><?php echo wp_unslash($this->getValue('footer_scripts')) ?></textarea></p><p class="description"><?php esc_html_e('Here comes your Google Analytics code or any other JS code you want to be loaded in the footer of your website.', 'fona') ?></p></td>
                        </tr>
                    ...
                    <table id="advanced-settings" class="tab-table">
                        ...
                        ?>
                        <caption><?php esc_html_e('Advanced Options', 'fona') ?></caption>
                        <tr>
                            <th rowspan="scope"><?php esc_html_e('Enable Development Mode', 'fona') ?></th>
                            <td>
                                <label>
                                    <input type="checkbox" name="<?php echo esc_attr($this->getName('enable_dev_mode')) ?>" value="1"<?php if ($enable_dev_mode) echo ' checked'; ?>>
                                    <span class="description"><?php esc_html_e('This option is for theme developers only. Use it with caution!', 'fona'); ?></span></label>
                            </td>
                        </tr>
                        <tr>
                            <th rowspan="scope"><?php esc_html_e('Responsive Breakpoint for Mobile (px)', 'fona') ?></th>
                            <td>
                                ...
                                <p class="description"><?php esc_html_e('Set a custom mobile breakpoint at which your site layout will be rendered for mobile devices. E.g. 768px. The default value is inherited from Bootstrap 4 - 992px.', 'fona'); ?></p>
                            </td>
                        </tr>
                        <?php do_settings_fields(self::GROUP, 'advanced') ?>
                    </table>
                    <table id="import-export" class="tab-table">
                        <caption><?php esc_html_e('Import/Export Theme Options', 'fona') ?></caption>
                        <tr>
