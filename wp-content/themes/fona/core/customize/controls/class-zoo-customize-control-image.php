        ...
        <div class="zoo-customize-control zoo-customize-control-{{ data.type }} {{ data.class }} zoo-customize-control-name-{{ data.original_name }}" data-required="{{ required }}" data-field-name="{{ data.name }}">
            ...
            <div class="zoo-customize-control-settings-inner zoo-media-type-{{ data.type }}">
                <div class="zoo-media">
                    ...
                    <div class="zoo-image-preview <# if ( url ) { #> zoo-has-file <# } #>" data-no-file-text="<?php esc_attr_e( "No file selected", 'fona' ); ?>">
                        <#
                    ...
                    <button type="button" class="button zoo-add <# if ( url ) { #> zoo-hide <# } #>"><?php esc_html_e( 'Select', 'fona' ); ?></button>
                    <button type="button" class="button zoo-change <# if ( ! url ) { #> zoo-hide <# } #>"><?php esc_html_e( 'Change', 'fona' ); ?></button>
                    <button type="button" class="button zoo-remove <# if ( ! url ) { #> zoo-hide <# } #>"><?php esc_html_e( 'Remove', 'fona' ); ?></button>
                </div>
            </div>
        </div>
        </script>
