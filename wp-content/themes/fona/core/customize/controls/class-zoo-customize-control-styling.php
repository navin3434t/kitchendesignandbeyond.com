...
final class Zoo_Customize_Control_Styling extends Zoo_Customize_Control_Modal
{
    ...
    static function control_template()
    {
        ...
        <div class="zoo-actions">
            <a href="#" title="<?php esc_attr_e( 'Reset to default', 'fona' ); ?>" class="action--reset" data-control="{{ data.name }}"><span class="dashicons dashicons-image-rotate"></span></a>
            <a href="#" title="<?php esc_attr_e( 'Toggle edit panel', 'fona' ); ?>" class="action--edit" data-control="{{ data.name }}"><span class="dashicons dashicons-edit"></span></a>
        </div>
