            ...
            if ($this->setting_type != 'custom_html') {
                ...
                if ($this->setting_type == 'repeater') {
                    ?><div class="zoo-repeater-actions">
                        <a href="#" class="zoo-repeater-reorder" data-text="<?php esc_attr_e('Reorder', 'fona'); ?>" data-done="<?php esc_attr_e('Done', 'fona'); ?>"><?php _e('Reorder', 'fona'); ?></a>
                        <?php if ($this->addable !== false) { ?>
                            <button type="button" class="button zoo-repeater-add-new"><?php esc_html_e('Add an item', 'fona'); ?></button><?php
                        }
                    ?></div><?php
                }
            }
