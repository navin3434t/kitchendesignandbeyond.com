...
return [
    [
        'name' => 'zoo_style',
        'type' => 'panel',
        'label' => esc_html__('Style', 'fona'),
    ], [
        'name' => 'zoo_general_style',
        'type' => 'section',
        'label' => esc_html__('General Style', 'fona'),
        'panel' => 'zoo_style',
    ...
    [
        ...
        'description' => esc_html__('Predefined color scheme to Style', 'fona'),
        'default' => 'default',
        'choices' => [
            'default' => esc_html__('Default', 'fona'),
            'black' => esc_html__('Black', 'fona'),
            'blue' => esc_html__('Blue', 'fona'),
            'red' => esc_html__('Red', 'fona'),
            'yellow' => esc_html__('Yellow', 'fona'),
            'green' => esc_html__('Green', 'fona'),
            'grey' => esc_html__('Grey', 'fona'),
    ...
    [
        ...
        'type' => 'color',
        'section' => 'zoo_general_style',
        'title' => esc_html__('Primary color', 'fona'),
        'selector' => ".accent-color",
        'css_format' => 'color: {{value}};',
        'description' => esc_html__('Primary color of theme apply only when preset is custom.', 'fona'),
        ...
        'type' => 'color',
        'section' => 'zoo_general_style',
        'title' => esc_html__('Heading color', 'fona'),
