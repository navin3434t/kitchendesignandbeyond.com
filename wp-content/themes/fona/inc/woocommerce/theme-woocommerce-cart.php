...
function zoo_login_button() {
	...
	echo wp_kses( '<p class="form-row  wrap-login-toggle-button"><a href=# class="toggle-login-form button toggle-button" title="' . esc_attr__( 'Login', 'fona' ) . '">' . esc_html__( 'Login', 'fona' ) . '</a></p>', $allow_html );
}
...
function zoo_register_button() {
	...
	if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' && ! is_checkout() ) {
		echo wp_kses( '<p class="form-row wrap-register-toggle-button"><a href=# class="toggle-register-form button toggle-button" title="' . esc_attr__( 'Register', 'fona' ) . '">' . esc_html__( 'Register', 'fona' ) . '</a></p>', $allow_html );
	} else {
		return;
	}
}
