...
<form id="edd_register_form" class="edd_form" action="" method="post">
	...
	<fieldset>
		...
		<p>
			...
			<input class="edd-submit" name="edd_register_submit" type="submit" value="<?php esc_attr_e( 'Register', 'fona' ); ?>" />
		</p>
