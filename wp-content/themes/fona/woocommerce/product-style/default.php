...
<div class="wrap-product-info">
    ...
    <h3 class="product-name jjj"><a href="<?php the_permalink(); ?>"
	...
	<div class="cstdect"><br><a class="readmr" href="<?php the_permalink(); ?>">Read More</a><a class="readmr get_quote_now popmake-17064" href="javascript:" style="cursor: pointer;">Get Quote Now</a></div>
    <div class="wrap-after-shop-title mmm">
        <?php
