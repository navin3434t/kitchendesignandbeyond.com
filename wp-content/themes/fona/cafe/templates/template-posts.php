                        ...
                        <div class="wrap-media">
                            ...
                            if (is_sticky()) {
                                ...
                                <span class="sticky-post-label"><i
                                            class="cs-font clever-icon-light"></i> <?php echo esc_html__('Featured', 'fona') ?></span>
                                <?php
                            } ?>
                        ...
                        if ($settings['show_read_more'] == 'true') {
                            ...
                            <a href="<?php the_permalink(); ?>"
                               class="readmore"><?php
                                ...
                                echo esc_html__('Continue Reading', 'fona'); ?></a>
                            <?php
                        }
                        ?>
                    </div>
                    ...
                    if ($layout == 'list' || $layout == 'full') {
                        ...
                        <div class="wrap-header">
                            ...
                            <ul class="post-info">
                                ...
                                if ($settings['show_author_post'] == 'true') {
                                    ?>
                                    <li class="author-post"><?php echo esc_html__('By ', 'fona') ?>
                                        <a href="<?php echo esc_url(get_author_posts_url(get_the_author_meta('ID'), get_the_author_meta('user_nicename'))); ?>"
                                           title="<?php echo esc_attr(get_the_author()) ?>">
                                            <?php echo esc_html(get_the_author()) ?>
                                        </a>
                                ...
                                if ($settings['show_date_post'] == 'true') {
                                    ?>
                                    <li class="post-date"><?php echo esc_html__('On ', 'fona') ?> <?php echo esc_html(get_the_date()); ?>
                                    </li>
                                <?php
                                }
                                if ($settings['show_cat_post'] == 'true') {
                                    ?>
                                    <li class="list-cat"><?php echo esc_html__('In ', 'fona') ?> <?php echo get_the_term_list(get_the_ID(), 'category', '', ', ', ''); ?>
                                    </li>
                                <?php
                                }
                                ?>
                        ...
                        //End IMG Left IMG Style
                            ...
                            ?>
                            <div class="wrap-post-item-content">
                                <?php if($settings['show_author_post'] == 'true' || $settings['show_date_post'] == 'true' || $settings['show_cat_post'] == 'true'){ ?>
                                    ...
                                    <a href="<?php the_permalink(); ?>"
                                       class="readmore"><?php
                                        if ($style == 'image-shadow') {
                                            ...
                                            echo esc_html__('Continue Reading', 'fona');
                                        } ?></a>
                                    <?php
                                }
                                ?>
