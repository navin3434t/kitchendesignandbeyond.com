    ...
    if ($the_query->have_posts()):
        ...
        if ($atts['pagination'] == 'standard') :
            if (function_exists("cvca_pagination")) :
                cvca_pagination(3, $the_query, '', '<i class="fa fa-angle-double-left" aria-hidden="true"></i> ' . esc_html__('Previous', 'zoo-consultech'), esc_html__('Next', 'zoo-consultech') . ' <i class="fa fa-angle-double-right" aria-hidden="true"></i>');
            endif;
        endif;
        //end paging
    endif;
