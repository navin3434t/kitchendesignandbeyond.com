<div id="vp-pfui-format-quote-fields" style="display: none;">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-content"><?php _e('Source Content', 'vp-post-formats-ui'); ?></label>
        <textarea  name="_format_quote_source_content" id="vp-pfui-format-quote-source-content" tabindex="1" ><?php echo esc_html(get_post_meta($post->ID, '_format_quote_source_content', true)); ?></textarea>
	</div>
	<div class="vp-pfui-elm-block">
