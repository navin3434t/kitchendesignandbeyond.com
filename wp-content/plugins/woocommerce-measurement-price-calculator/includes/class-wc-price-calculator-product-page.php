...
class WC_Price_Calculator_Product_Page {
	...
	public function enqueue_frontend_scripts() {
		...
		if ( $product && \WC_Price_Calculator_Product::calculator_enabled( $product ) ) {
			...
			wp_enqueue_script( 'wc-price-calculator', wc_measurement_price_calculator()->get_plugin_url() . '/assets/js/frontend/wc-measurement-price-calculator.js', array( 'jquery', 'jquery-cookie', 'jquery-tiptip' ), $version );
