							        ...
							        <div id="export" class="panel">
							            <div class="postbox">
							                <header>
							                    ...
							                    <p class="description">
							                        <?php _e( 'To export this Plugin\'s settings, click either "Export as JSON" or "Export as JSON, Zipped".', $this->plugin->name ); ?>
							                        <br />
							                        <?php _e( 'You can then import the generated file into another Plugin installation.', $this->plugin->name ); ?>
							                        <br />
							                        <?php _e( 'Including this file in a support request? We recommend using "Export as JSON, Zipped".', $this->plugin->name ); ?>
							                    </p>
							                </header>

							                <div class="wpzinc-option">
							                    <a href="admin.php?page=<?php echo $this->plugin->name; ?>-import-export&export=json" class="button button-primary" title="<?php _e( 'Export', $this->plugin->name ); ?>">
							                        <?php _e( 'Export as JSON', $this->plugin->name ); ?>
							                    </a>

							                    <a href="admin.php?page=<?php echo $this->plugin->name; ?>-import-export&export=zip" class="button button-primary" title="<?php _e( 'Export', $this->plugin->name ); ?>">
							                        <?php _e( 'Export as JSON, Zipped', $this->plugin->name ); ?>
							                    </a>
							                </div>
							            </div>
							        </div>
