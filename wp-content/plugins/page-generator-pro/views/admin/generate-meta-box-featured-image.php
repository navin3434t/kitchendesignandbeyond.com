...
<div class="wpzinc-vertical-tabbed-ui no-border featured_image id url pexels pixabay">
    <!-- Tabs -->
    <ul class="wpzinc-nav-tabs wpzinc-js-tabs" data-panels-container="#featured-image-container" data-panel=".featured-image-panel" data-active="wpzinc-nav-tab-vertical-active">
        ...
        <li class="wpzinc-nav-tab aperture">
            <a href="#featured-image-exif">
                <?php _e( 'EXIF', $this->base->plugin->name ); ?>
            </a>
        </li>
    </ul>
    ...
    <div id="featured-image-container" class="wpzinc-nav-tabs-content no-padding">
        ...
        <div id="featured-image-search-parameters" class="featured-image-panel">
            <div class="postbox">
                ...
                <div class="wpzinc-option featured_image id">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_media_library_title]" id="featured_image_media_library_title" value="<?php echo $this->settings['featured_image_media_library_title']; ?>" placeholder="<?php _e( 'e.g. building', 'page-generator-pro' ); ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                ...
                <div class="wpzinc-option featured_image id">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_media_library_caption]" id="featured_image_media_library_caption" value="<?php echo $this->settings['featured_image_media_library_caption']; ?>" placeholder="<?php _e( 'e.g. building', 'page-generator-pro' ); ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                    <p class="description">
                ...
                <div class="wpzinc-option featured_image id">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_media_library_alt]" id="featured_image_media_library_alt" value="<?php echo $this->settings['featured_image_media_library_alt']; ?>" placeholder="<?php _e( 'e.g. building', 'page-generator-pro' ); ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                    <p class="description">
                ...
                <div class="wpzinc-option featured_image id">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_media_library_description]" id="featured_image_media_library_description" value="<?php echo $this->settings['featured_image_media_library_description']; ?>" placeholder="<?php _e( 'e.g. building', 'page-generator-pro' ); ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                    <p class="description">
                ...
                <!-- URL, Pexels and Pixabay -->
                <div class="wpzinc-option featured_image url pexels pixabay">
                    <div class="left">
                        <label for="featured_image" class="featured_image url"><?php _e( 'URL', 'page-generator-pro' ); ?></label>
                        <label for="featured_image" class="featured_image pexels pixabay"><?php _e( 'Term', 'page-generator-pro' ); ?></label>
                    </div>
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image]" id="featured_image" value="<?php echo $this->settings['featured_image']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                ...
                <!-- Pexels and Pixabay -->
                <div class="wpzinc-option featured_image pexels pixabay">
                    <div class="left">
        ...
        <div id="featured-image-output" class="featured-image-panel">
            <div class="postbox">
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    <div class="left">
                        <label for="featured_image_title"><?php _e( 'Title', 'page-generator-pro' ); ?></label>
                    </div>
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_title]" id="featured_image_title" value="<?php echo $this->settings['featured_image_title']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_caption]" id="featured_image_caption" value="<?php echo $this->settings['featured_image_caption']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_alt]" id="featured_image_alt" value="<?php echo $this->settings['featured_image_alt']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_description]" id="featured_image_description" value="<?php echo $this->settings['featured_image_description']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_filename]" id="featured_image_filename" value="<?php echo $this->settings['featured_image_filename']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
        ...
        <div id="featured-image-exif" class="featured-image-panel">
            <div class="postbox">
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_exif_latitude]" id="featured_image_exif_latitude" value="<?php echo $this->settings['featured_image_exif_latitude']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_exif_longitude]" id="featured_image_exif_longitude" value="<?php echo $this->settings['featured_image_exif_longitude']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_exif_comments]" id="featured_image_exif_comments" value="<?php echo $this->settings['featured_image_exif_comments']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                </div>
                ...
                <div class="wpzinc-option featured_image id url pexels pixabay">
                    ...
                    <div class="right">
                        <input type="text" name="<?php echo $this->base->plugin->name; ?>[featured_image_exif_description]" id="featured_image_exif_description" value="<?php echo $this->settings['featured_image_exif_description']; ?>" class="widefat wpzinc-autocomplete" />
                    </div>
                </div>
            </div>
            <!-- /.postbox -->
