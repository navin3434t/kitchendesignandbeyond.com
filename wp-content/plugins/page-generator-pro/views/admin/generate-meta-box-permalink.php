...
<div class="wpzinc-option">
	...
	<div class="full">
		<input type="text" id="permalink" name="<?php echo $this->base->plugin->name; ?>[permalink]" id="permalink" value="<?php echo $this->settings['permalink']; ?>" class="widefat wpzinc-autocomplete" />
