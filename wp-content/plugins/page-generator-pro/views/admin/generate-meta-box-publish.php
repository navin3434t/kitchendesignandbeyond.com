...
<div class="wpzinc-option sidebar specific">
	...
	<div class="full">
		<input type="date" name="<?php echo $this->base->plugin->name; ?>[date_specific]" id="date_specific" value="<?php echo $this->settings['date_specific']; ?>" class="widefat" />
	</div>
	<p class="description">
		<?php _e( 'Each generated page will use this date as the published date.', 'page-generator-pro' ); ?>
	</p>
</div>
...
<div class="wpzinc-option sidebar future">
	...
	<div class="right">
		<input type="number" name="<?php echo $this->base->plugin->name; ?>[schedule]" id="schedule" value="<?php echo $this->settings['schedule']; ?>" step="1" min="1" />
		<select name="<?php echo $this->base->plugin->name; ?>[scheduleUnit]" size="1" class="widefat">
			<?php
	...
	<p class="description">
		<?php _e( 'For each generated page, increments the publication date and time, relative to the last generated page.', 'page-generator-pro' ); ?>
	</p>
</div>