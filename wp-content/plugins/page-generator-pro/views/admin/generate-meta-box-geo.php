<div class="wpzinc-option">    
    ...
    <div class="right">
        <input type="text" name="<?php echo $this->base->plugin->name; ?>[latitude]" id="latitude" value="<?php echo $this->settings['latitude']; ?>" placeholder="<?php _e( 'Latitude', 'page-generator-pro' ); ?>" class="widefat wpzinc-autocomplete" />
...
<div class="wpzinc-option">    
    ...
    <div class="right">
        <input type="text" name="<?php echo $this->base->plugin->name; ?>[longitude]" id="longitude" value="<?php echo $this->settings['longitude']; ?>" placeholder="<?php _e( 'Longitude', 'page-generator-pro' ); ?>" class="widefat wpzinc-autocomplete" />
