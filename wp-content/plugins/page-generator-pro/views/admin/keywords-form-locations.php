	    ...
	    <div id="poststuff">
	    	<div id="post-body" class="metabox-holder columns-1">
	    		...
	    		<div id="post-body-content">
	    			<!-- Form Start -->
			        <form name="post" method="post" action="admin.php?page=<?php echo $page; ?>&amp;cmd=form-locations" enctype="multipart/form-data" id="keywords-generate-locations">		
			                ...
			                <div id="keyword-panel" class="postbox">
			                    ...
			                    <div class="wpzinc-option">
			                    	...
			                    	<div class="right">
				                    	...
				                    	<p class="description">
				                    		...
				                    		<?php _e( 'The Keyword will be populated with Locations falling within the given radius from the given starting point.  This method is useful if, for example, your product or service targets a specific mileage radius from a central location.' ); ?>
				                    		<br />

											<strong><?php _e( 'Area', 'page-generator-pro' ); ?></strong>
				                    		<?php _e( 'The Keyword will be populated with Locations falling within the given City, County and/or Region.  This method is useful if, for example, your product or service targets a specific City, County or Region.' ); ?>
				                    	</p>
			                    	</div>
			                    </div>
			                    ...
			                    <div class="area">
			                    	<div class="wpzinc-option">
				                    	...
				                    	<div class="right">
				                    		<select name="region_id[]" multiple="multiple" class="wpzinc-selectize" data-action="page_generator_pro_georocket" data-api-call="get_regions" data-country-code="country_code" data-value-field="id" data-output-fields="region_name,country_code">
				                    		</select>
				                    ...
				                    <div class="wpzinc-option">
				                    	...
				                    	<div class="right">
				                    		<select name="county_id[]" multiple="multiple" class="wpzinc-selectize-api" data-action="page_generator_pro_georocket" data-api-call="get_counties" data-api-search-field="county_name" data-api-fields="region_id[]" data-country-code="country_code" data-value-field="id" data-output-fields="county_name,region_name">
				                    		</select>
