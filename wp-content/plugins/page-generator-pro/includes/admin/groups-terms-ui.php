<?php
/**
 * Handles the Groups Taxonomy Type UI
 * 
...
class Page_Generator_Pro_Groups_Terms_UI {
     ...
     */
    public function output_add_term_fields( $taxonomy ) {
     ...
     * @param   string      $taxonomy   Taxonomy
     */
    public function add_term_wp_editor( $taxonomy ) {
     ...
     * @param   string      $taxonomy   Taxonomy
     */
    public function edit_term_wp_editor( $term, $taxonomy ) {
     ...
     * @param   string      $taxonomy   Taxonomy
     */
    public function output_edit_term_start( $term, $taxonomy ) {
     ...
     * @param   string      $taxonomy   Taxonomy
     */
    public function output_edit_term_fields( $term, $taxonomy ) {
     ...
     * @param   string      $taxonomy   Taxonomy
     */
    public function output_edit_term_end( $term, $taxonomy ) {
    ...
    public function save_term( $term_id, $taxonomy_term_id, $taxonomy ) {
        ...
        $settings = array_merge( array(
            'title'         => ( isset( $_POST['tag-name'] ) ? sanitize_text_field( $_POST['tag-name'] ) : sanitize_text_field( $_POST['name'] ) ),
