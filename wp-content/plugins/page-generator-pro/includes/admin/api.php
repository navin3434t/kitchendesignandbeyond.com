...
class Page_Generator_Pro_API {
     ...
     * @param   bool    $json_response  JSON Response expected (optional)
     * @return  mixed                   WP_Error | object
     */
    public function get( $cmd, $params = array(), $json_response = true ) {

        return $this->request( $cmd, 'get', $params, $json_response );
     ...
     * @return  mixed                   WP_Error | object
     */
    public function post( $cmd, $params = array(), $json_response = true ) {

        return $this->request( $cmd, 'post', $params, $json_response );
    ...
    private function set_timeout() {
         ...
         */
        $timeout = apply_filters( 'page_generator_pro_api_set_timeout', $timeout );
     ...
     * @return  mixed                   WP_Error | object
     */
    private function request( $cmd, $method = 'get', $params = array(), $json_response = true ) {
        ...
        // Just return the body if it's not JSON
        if ( ! $json_response ) {
            return $body;
        }
        ...
        if ( isset( $body->error ) ) {
            return new WP_Error( 'page_generator_pro_api_request_error', $body->error ); 
        }
