...
class Page_Generator_Pro_AJAX {
    ...
    public function generate_content() {
         ...
         */
        do_action( 'page_generator_pro_generate_content_before', $group['group_id'], $group['test_mode'], 'browser' );

        // Run
        $result = $this->base->get_class( 'generate' )->generate_content( $group['group_id'], $group['current_index'], $group['test_mode'], 'browser' );
         ...
         * @param   string  $system     System
         */
        do_action( 'page_generator_pro_generate_content_after', $group['group_id'], $group['test_mode'], 'browser' );
    ...
    public function generate_term() {
         ...
         * @param   string  $system     System
         */
        do_action( 'page_generator_pro_generate_terms_before', $group['group_id'], $group['test_mode'], 'browser' );
         ...
         * @param   string  $system     System
         */
        do_action( 'page_generator_pro_generate_terms_after', $group['group_id'], $group['test_mode'], 'browser' );
