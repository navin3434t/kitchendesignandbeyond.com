...
function page_generator_pro_reinit_selectize() {
	...
	( function( $ ) {
		 ...
		 */
		$( 'input.wpzinc-selectize-freeform, .wpzinc-selectize-freeform input' ).each( function() {
		 ...
		 */
		$( 'select.wpzinc-selectize-drag-drop, .wpzinc-selectize-drag-drop select' ).selectize( {
			plugins: [ 'drag_drop' ],
		    delimiter: ',',
		    persist: false,
		    create: false
		 ...
		 */
		$( 'select.wpzinc-selectize-search, .wpzinc-selectize-search select' ).each( function() {
		 ...
		 */
		$( 'select.wpzinc-selectize-api, .wpzinc-selectize-api select' ).each( function() {
		 ...
		 * - Region
		 */
		$( 'select.wpzinc-selectize, .wpzinc-selectize select' ).each( function() {
...
function page_generator_pro_destroy_selectize() {
	...
	( function( $ ) {
		...
		$( page_generator_pro_selectize.fields.join( ', ' ) ).selectize().each( function() {
