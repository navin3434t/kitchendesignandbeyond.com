        ...
        <div id="items-left">
            <div id="available-items" class="items-holder-wrap ui-droppable">
                ...
                <div class="item-holder">
                    ...
                    <div id="item-list">
                        <!--active filter-->
                        <?php require ZOO_LN_TEMPLATES_PATH.'admin/filter-setting/active-filter.php';?>
                        <!--attribute-->
                        ...
                        <!--tags-->
                        <?php require_once ZOO_LN_TEMPLATES_PATH.'admin/filter-setting/tags.php';?>
                        <!--on sale-->
                        ...
                        require_once ZOO_LN_TEMPLATES_PATH.'admin/filter-setting/range-slider.php';
                        ?>
                        <!--review-->
                            ...
                            <div id="<?php echo($col_id); ?>" class="items-sortables ui-droppable ui-sortable">
                                ...
                                if (isset($data[$col_id]) && count($data[$col_id])) {
                                    ...
                                    foreach ($sidebar_data as $item_data) {
                                        ...
                                        } else if ($item_data['item_type'] == 'active-filter') {
